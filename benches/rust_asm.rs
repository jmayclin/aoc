use aoc2023::{day1::{day1_p1, rust_day1_p1}, day6::{day6_p2, rust_day6_p2}, day8::{day8_p1, rust_day8_p1}};
...
fn day8_p1_benchmark(c: &mut Criterion) {
    ...
    let ptr = input.as_ptr();
    let len = input.len() as u64;
    c.bench_function("assembly", |b| b.iter(|| unsafe { day8_p1(ptr, len) }));
    c.bench_function("rust", |b| b.iter(|| rust_day8_p1(ptr, len)));
}
